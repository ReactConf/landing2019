			...
			<ParallaxProvider>
				<main>
							...
							<Parallax y={[-20, 60]} tagOuter="div">
								...
								<a className="btn" href="/ticket">
									...
									>
										...
										>
											<path
												d="M8.993 23.25H2.451a1.5 1.5 0 0 1-1.487-1.694l1.858-14.25A1.5 1.5 0 0 1 4.31 6h1.116a1.5 1.5 0 0 1 1.487 1.306l2.08 15.944zM14.243 6h5.433a1.5 1.5 0 0 1 1.487 1.306l1.859 14.25a1.5 1.5 0 0 1-1.488 1.694H8.993M5.426 6h6.567"/>
											<path
												d="M17.993 10.5V3.75a3 3 0 1 0-6 0v6.75M9.578 1.253a3.002 3.002 0 0 0-1.335 2.5V6"/>
										</g>
									</svg>
									Buy ticket
								</a>
						...
						<section className="section__main">
							<div className="ticket">
								<div className="ticket--card">
									...
									<p>
										One full days of knowledge sharing and community with people who Code and LOVE React.
									</p>
									<a href="/ticket" className="btn" target="_blank">
										Preorder
									</a>
								</div>
							</div>
							...
							<section className="section__main">
								...
								<Grid width={180} gap={"var(--gap)"}>
									<figure className="sponsors--item">
										<a href="http://vira.co.com/" target="_blank">
											<img
									...
									<figure className="sponsors--item">
										<a href="http://baharnet.ir/" target="_blank">
											<img
									...
									<figure className="sponsors--item">
										<a href="https://ponisha.ir/" target="_blank">
											<img
									...
									<figure className="sponsors--item">
										<a href="https://www.afkarnews.com/" target="_blank">
											<img
									...
									<figure className="sponsors--item">
										<a href="https://binosha.com" target="_blank">
											<img
									...
									<figure className="sponsors--item">
										<a href="https://aasaam.com/" target="_blank">
											<img
									...
									<figure className="sponsors--item">
										<a href="https://arjang.ac.ir/" target="_blank">
											<img
									...
									<figure className="sponsors--item">
										<a href="https://ciwiran.com/" target="_blank">
											<img
									...
									<figure className="sponsors--item">
										<a href="http://frontcast.ir/" target="_blank">
											<img
									...
									<figure className="sponsors--item">
										<a href="https://gadgetnews.net" target="_blank">
											<img
					...
					<footer className="footer">
						<div className="container">
							<a href="http://hastnama.com" className="footer-logo" target="_blank">
								<svg width="180px" height="60px" viewBox="0 0 4514 1120" version="1.1"
									 xmlns="http://www.w3.org/2000/svg">
									<g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
										<g id="Hastnama_New_Logo_2" transform="translate(1.000000, 1.000000)"
										   fillRule="nonzero" stroke="#373435" strokeWidth="0.900032">
											...
											<path
												...
												id="Shape" fill="#FFB142"></path>
										</g>
									</g>
								</svg>
							</a>
							<a href="https://azinro.com" className="footer-logo space" target="_blank">
								<img src="/static/images/partners/azinro.png"/>
							</a>
							<p>
								Organized with {'<love/>'} by <a href="http://hastnama.com" target="_blank">Hastnama
								Creative Solutions</a> & <a href="http://azinro.com" target="_blank">Azinro</a>.
							</p>
							<div className="socials">
								...
								<a href="https://www.instagram.com/reactconf/" target="_blank">
									<svg
										width="24"
										height="24"
										className="icon"
